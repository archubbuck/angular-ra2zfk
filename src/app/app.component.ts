...
import { DataSetColumn } from './model';
...
export class AppComponent {
  public selectedColumns: Array<DataSetColumn> = [];

  public selectableColumns = columns;

  //   public get selectableColumns() {
  //     return columns.filter((column) => !this.selectedColumns.includes(column));
  //   }

  public addRow(): DataSetColumn {
